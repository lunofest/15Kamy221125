...
function updateTimer() {
  const targetDate = new Date("november 22, 2025 22:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543815508149'; // Número para el primer botón
  const recipientNumber2 = '543813386663'; // Número para el segundo botón
